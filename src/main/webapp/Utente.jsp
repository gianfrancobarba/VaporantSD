                     ...
                     <%@ page import="com.vaporant.repository.AddressDaoImpl" %>
                        <%@ page import="com.vaporant.controller.OrderControl" %>
                           <%@ page import="com.vaporant.controller.ModifyControl" %>
                              <%@ page import="com.vaporant.util.DataSourceUtil" %>
                                 <%@ page import="javax.sql.DataSource" %>
                                    <% UserBean user=(UserBean) request.getSession().getAttribute("user");
                                       if(user.getEmail()==null){ response.sendRedirect("loginForm.jsp"); } DataSource
                                       ds=DataSourceUtil.getDataSource(); AddressDaoImpl addressDao=new
                                       AddressDaoImpl(ds); List<AddressBean> indirizzi =
                                       null;
                                       if(addressDao.findByID(user.getId()) != null)
                                       indirizzi = addressDao.findByID(user.getId());

                                       OrderDaoImpl orderDao = new OrderDaoImpl(ds);
                                             ...
                                             <%@include file="Header.jsp" %>
                                                ...
                                                <%if(indirizzi !=null){ %>
                                                   <div class="address">
                                                      ...
                                                      <button onclick="location.href='AddressForm.jsp'"
                                                         class="btn">AGGIUNGI
                                                         INDIRIZZO</button>
                                                      <br>
                                                      <%} %>
