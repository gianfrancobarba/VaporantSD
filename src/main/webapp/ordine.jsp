<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import = "com.vaporant.model.OrderBean,com.vaporant.model.UserBean" %>
...
<!DOCTYPE html>
<html lang = "it">
	<%@ page contentType="text/html; charset=UTF-8" import="java.util.*,com.vaporant.model.ProductBean,com.vaporant.model.Cart"%>
